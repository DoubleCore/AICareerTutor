...
const styles = StyleSheet.create({
  ...
  thinkingRow: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: spacing.xl, paddingHorizontal: spacing.sm },
