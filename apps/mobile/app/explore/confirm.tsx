...
const styles = StyleSheet.create({
  ...
  pageSubtitle: { marginTop: spacing.sm, color: colors.muted, fontSize: 15, lineHeight: 22, fontWeight: "600" },
  introCard: {
    marginTop: -8,
  ...
  introText: { color: "#334155", fontSize: 13, lineHeight: 21, fontWeight: "600" },
  sectionCard: {
    borderRadius: radius.lg,
    padding: spacing.lg,
    backgroundColor: "#fff",
  ...
  cardTitle: { flex: 1, color: "#0B1D3A", fontSize: 17, lineHeight: 23, fontWeight: "900" },
  ...
  editButtonText: { color: colors.muted, fontSize: 13, fontWeight: "900" },
  fieldList: { gap: spacing.sm },
  infoRow: { flexDirection: "row", gap: spacing.lg, alignItems: "flex-start" },
  infoLabel: { width: 84, color: colors.muted, fontSize: 14, lineHeight: 22, fontWeight: "700" },
  infoValue: { flex: 1, color: "#0B1D3A", fontSize: 14, lineHeight: 22, fontWeight: "800" },
  aiCard: {
    borderRadius: radius.lg,
    padding: spacing.lg,
    backgroundColor: "#fff",
  ...
  aiTitleWrap: { flex: 1 },
  aiBased: { color: colors.muted, fontSize: 12, fontWeight: "700" },
  bulletList: { gap: spacing.sm },
  bulletRow: { flexDirection: "row", alignItems: "flex-start", gap: spacing.sm },
  bullet: { width: 5, height: 5, borderRadius: 3, backgroundColor: "#0B1D3A", marginTop: 8 },
  bulletText: { flex: 1, color: "#24324A", fontSize: 13, lineHeight: 20, fontWeight: "600" },
