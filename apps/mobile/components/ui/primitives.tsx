...
const styles = StyleSheet.create({
  ...
  webModalFrame: { width: "100%", maxWidth: 390, alignSelf: "center" },
  modalOverlay: { position: "absolute", left: 0, right: 0, top: 0, bottom: 0, backgroundColor: "rgba(17,24,39,0.28)" },
  sheet: { position: "absolute", left: 0, right: 0, bottom: 0, width: "100%", maxHeight: "72%", padding: spacing.lg, paddingBottom: spacing.xl, backgroundColor: colors.card, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, gap: spacing.md },
